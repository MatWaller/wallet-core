...
export class BitcoinScript {
    ...
    public static buildForAddress(address: string): BitcoinScript {
        return BitcoinScript.createWithNativeHandle(WalletCore.Js_wallet_core_napi_BitcoinScript_buildForAddress(address));
    }
