...
#include "generated/IocoinAddress.h"
...
Object Init(Env env, Object exports) {
  ...
  // IocoinAddress
  exports.Set(String::New(env, "Js_wallet_core_napi_IocoinAddress_delete"), Function::New(env, Js_wallet_core_napi_IocoinAddress_delete));
  exports.Set(String::New(env, "Js_wallet_core_napi_IocoinAddress_description"), Function::New(env, Js_wallet_core_napi_IocoinAddress_description));
  exports.Set(String::New(env, "Js_wallet_core_napi_IocoinAddress_equals"), Function::New(env, Js_wallet_core_napi_IocoinAddress_equals));
  exports.Set(String::New(env, "Js_wallet_core_napi_IocoinAddress_isValidString"), Function::New(env, Js_wallet_core_napi_IocoinAddress_isValidString));
  exports.Set(String::New(env, "Js_wallet_core_napi_IocoinAddress_createWithString"), Function::New(env, Js_wallet_core_napi_IocoinAddress_createWithString));
  exports.Set(String::New(env, "Js_wallet_core_napi_IocoinAddress_createWithPublicKey"), Function::New(env, Js_wallet_core_napi_IocoinAddress_createWithPublicKey));
