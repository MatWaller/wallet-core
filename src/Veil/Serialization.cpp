...
const string TYPE_PREFIX_MSG_SEND = "Veil-sdk/MsgSend";
const string TYPE_PREFIX_MSG_DELEGATE = "Veil-sdk/MsgDelegate";
const string TYPE_PREFIX_MSG_UNDELEGATE = "Veil-sdk/MsgUndelegate";
const string TYPE_PREFIX_MSG_REDELEGATE = "Veil-sdk/MsgBeginRedelegate";
const string TYPE_PREFIX_MSG_WITHDRAW_REWARD = "Veil-sdk/MsgWithdrawDelegationReward";
...
json Veil::signaturePreimage(const Proto::SigningInput& input) {
    return {
...
json Veil::transactionJSON(const Proto::SigningInput& input, const Data& signature) {
